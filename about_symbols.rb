...
class AboutSymbols < EdgeCase::Koan
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      assert_equal true, all_symbols.include?(:minmax)
    end
  end
  ...
  # Answer: Symbols can't be modified and should be used only when need repeated access
  # to them. Dynamically creating a lot of symbols means using a lot of memory which
  # can't be freed until program's execution ends.
end
